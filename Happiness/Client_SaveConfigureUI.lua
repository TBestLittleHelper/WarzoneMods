function Client_SaveConfigureUI(alert, addCard)
	...
	local celebratingCardID = addCard("Celebrating",
		...
		"VeryHappyCard.png", numPieces, minPieces, 1,
		cardWeight);
	local happyCardID = addCard("Happy",
		"Your territories are happy. They will produce 5 extra income.",
		"VeryHappyCard.png", numPieces, minPieces, initialPieces,
		cardWeight);
	...
	Mod.Settings.AllCardIDs = { [celebratingCardID] = true, [happyCardID] = true, [contentCardID] = true,
	[misserableCardID] = true, [riotingCardID] = true }
end
