...
local Advancements = {
	...
	Armies = {
		...
		Upgrades = {
			...
			{ UID = 61, Name = "Spy Network", Description = "Get a report of one random players status at the start of your turn.", SpyReports = 1,      Cost = 15,       AdvanceTurn = AdvanceTurn.Start },
		},
	},
}
